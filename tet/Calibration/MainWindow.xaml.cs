    ...
    public partial class MainWindow : IConnectionStateListener
    {
        ...
        private void startTracking()
        {
            ...
            if (cursorControl == null)
            {
                if (m_Folder == "")
                {
                    MessageBox.Show("Please select folder to save logs");
                    return;
                }
                else
                {
                    cursorControl = new CursorControl(activeScreen, true, true, m_Folder); // Lazy initialization
                }
            }
            else
        ...
        private void UpdateState()
        {
            ...
            else
            {
                ...
                btnMouse.Content = "Record";

                if (cursorControl != null && cursorControl.Enabled)
                    btnMouse.Content = "Recording";
